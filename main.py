...
start_button = tkinter.Button(text="Start", command=start_timer, font=(FONT_NAME, 10, "bold"), bg="white",
                              highlightthickness=0)
start_button.grid(row=3, column=1)

reset_button = tkinter.Button(text="Reset", font=(FONT_NAME, 10, "bold"), bg="white", highlightthickness=0,
                              command=reset_timer)
...
check_mark_label = tkinter.Label(fg=GREEN, bg=YELLOW, font="bold")
